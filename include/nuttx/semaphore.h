...
#  define NXSEM_INITIALIZER(c, f) \
    {(c), SEMWAITLIST_INITIALIZER, (f), NULL}                                           /* semcount, waitlist, flags, hhead */
# else
#  define NXSEM_INITIALIZER(c, f) \
    {(c), SEMWAITLIST_INITIALIZER, (f), {SEMHOLDER_INITIALIZER, SEMHOLDER_INITIALIZER}} /* semcount, waitlist, flags, holder[2] */
# endif
